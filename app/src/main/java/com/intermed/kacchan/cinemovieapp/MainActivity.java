...
import com.intermed.kacchan.cinemovieapp.adapter.AdapterCine;
import com.intermed.kacchan.cinemovieapp.adapter.AdapterDrawer;
import com.intermed.kacchan.cinemovieapp.data.CinemaData;
import com.intermed.kacchan.cinemovieapp.data.NavItem;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdapterDrawer adp = new AdapterDrawer(this, mNavItems);
    ...
    private void MyParsingGson(String url) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {;
            ...
            public void onResponse(String response) {
                ...
                a = mGson.fromJson(response, CinemaData.class);
                adapter = new AdapterCine(MainActivity.this, a.results);
